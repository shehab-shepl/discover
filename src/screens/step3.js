    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity style={styles.skipView} onPress={() => this.props.navigation.navigate('login')}>
                    <Text style={styles.txtSkip}>Skip</Text>
                    <Text style={styles.txtSkip}>	 </Text>

                </TouchableOpacity>
                <View style={styles.viewImg}>
                    <Image style={styles.img} source={require('../assets/pics/Layer2.png')} resizeMode='center' />
                </View>
                <Text style={styles.txtDiscover}>Pick Up Or delivery</Text>
                {/* <View style={styles.viewText}> */}
                <Text style={styles.txtSmall}>When you order, we’ll hook you up with exclusive coupons, special rewards.</Text>
                {/* </View> */}
