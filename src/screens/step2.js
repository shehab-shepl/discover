    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity style={styles.skipView} onPress={() => this.props.navigation.navigate('step3')}>
                    <Text style={styles.txtSkip}>Skip</Text>
                    <Text style={styles.txtSkip}>	 </Text>

                </TouchableOpacity>
                <View style={styles.viewImg}>
                    <Image style={styles.img} source={require('../assets/pics/Page-1.png')} resizeMode='center' />
                </View>
                <Text style={styles.txtDiscover}>Choose A Tasty dish</Text>
